...
always_comb
  ...
  o_done_arrange_dp_fft16 = 1; 
    ...
    begin  
      ...
      {t_a_real_to_btrfly_dp_fft16,t_a_imag_to_btrfly_dp_fft16}=t_arranged_input_dp_fft16[i_a_rd_index_dp_fft16];

      {t_b_real_to_btrfly_dp_fft16,t_b_imag_to_btrfly_dp_fft16}=t_arranged_input_dp_fft16[i_b_rd_index_dp_fft16];
